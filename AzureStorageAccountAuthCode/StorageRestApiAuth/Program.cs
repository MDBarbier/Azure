namespace StorageRestApiAuth
{
    ...
    {
        static string StorageAccountName = "<enter your storage account name here>";
        static string StorageAccountKey = "<enter your key here - to find go to the storage account in the Azure portal and go to Access keys page there will be 2 listed pick either>";
